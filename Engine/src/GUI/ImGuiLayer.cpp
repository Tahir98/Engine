...
void Engine::ImGuiLayer::InitImGui(Window& currentWindow) {
    ...
    ImGui_ImplGlfw_InitForOpenGL(currentWindow.GetNativeWindowPtr(), true);
...
void Engine::ImGuiLayer::StartNewFrame() {
...
void Engine::ImGuiLayer::RenderNewFrame() {
    // Rendering
    ImGui::Render();
